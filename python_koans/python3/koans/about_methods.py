...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        self.assertRegexpMatches(msg, r'my_global_function\(\) takes 2 positional arguments but [0-9]* were given')
    ...
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegexpMatches(self.method_with_documentation.__doc__, r"A string placed at the beginning of a function is used for documentation")
